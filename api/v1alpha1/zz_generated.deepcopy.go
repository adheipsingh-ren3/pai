...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TraefikMetricsConfig) DeepCopyInto(out *TraefikMetricsConfig) {
	*out = *in
	if in.Headers != nil {
		in, out := &in.Headers, &out.Headers
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TraefikMetricsConfig.
func (in *TraefikMetricsConfig) DeepCopy() *TraefikMetricsConfig {
	if in == nil {
		return nil
	}
	out := new(TraefikMetricsConfig)
